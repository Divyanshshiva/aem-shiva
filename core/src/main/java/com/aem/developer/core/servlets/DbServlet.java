...
import com.aem.developer.core.filters.dbutil.DatabaseConnectionHelper;
...
@Component(service=Servlet.class,
           property={
                   ...
                   "sling.servlet.paths=" + "/bin/dbmyservlet"
...
public class DbServlet extends SlingSafeMethodsServlet 
{
    ...
    {	
        ...
        con=helper.getDataBaseConnection("emp");
        //resp.getWriter().write("Title = " + resource.adaptTo(ValueMap.class).get("jcr:title"));
        resp.getWriter().write("connectionestablished"+con);
    }
}
