...
@Component(service=Servlet.class,
           property={
                   ...
                   "sling.servlet.paths=" + "/bin/nodemyservlet"
           })
public class NodeServlet extends SlingSafeMethodsServlet {

    private static final long serialVersionUID = 1L;
	private static Logger log = LoggerFactory.getLogger(NodeServlet.class);
...
try {
			 ...
			 */
			Resource resource = resourceResolver.getResource("/content/aemdeveloper/en");
