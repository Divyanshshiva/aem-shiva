...
@Component(service=Servlet.class,
           property={
                   ...
                   "sling.servlet.paths=" + "/bin/myrestfullservlet"
             
           })
public class RestFullServlet extends SlingSafeMethodsServlet 
{
    private static final long serialVersionUid = 1L;
    @Reference ReadJsonService readservice;
    @Override
    ...
    {	
        ...
        String response=readservice.getData();
